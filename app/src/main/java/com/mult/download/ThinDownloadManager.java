...
public class ThinDownloadManager implements DownloadManager {
    ...
    public ThinDownloadManager(int threadPoolSize) {
        Log.i("chyy", "ThinDownLoadManager (int threadPoolSize) ");
    ...
    @Override
    public void resumeDownload(DownloadRequest downloadRequest, int downloadID) {
        mRequestQueue.resumeDownload(downloadRequest,downloadID);
    }
    ...
    private static void setLoggingEnabled(boolean enabled) {
        DownLoadLog.setEnabled(enabled);
    }
}
